...
while True:
    if btn1.value:
        keyboard.send(Keycode.SEVEN) #1    
        time.sleep(0.1) 
    if btn2.value:
        keyboard.send(Keycode.EIGHT) #4
        time.sleep(0.1)
    if btn3.value:  
        keyboard.send(Keycode.NINE) #7 
        time.sleep(0.1)
    if btn4.value:
    ...
    if btn6.value:
        ...
        time.sleep(0.1)
    if btn7.value:
        keyboard.send(Keycode.ONE) #3
        time.sleep(0.1)
    if btn8.value:
        keyboard.send(Keycode.TWO) #6
        time.sleep(0.1)
    if btn9.value:
        keyboard.send(Keycode.THREE) #9
        time.sleep(0.1)
    time.sleep(0.05)
time.sleep(0.1)
